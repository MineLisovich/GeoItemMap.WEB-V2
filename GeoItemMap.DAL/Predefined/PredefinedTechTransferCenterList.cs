...
{
    /// <summary>
    /// Заполнение таблицы "TechTransferCenter"
    /// </summary>
    internal class PredefinedTechTransferCenterList
    {
        TechTransferCenter id1 = new()
        {  
            Id = 1,
            X = 53.46273714267153f,
            Y = 24.35466171473316f,
            ...
            NumberAcceptedWorkProposals = 25,
            NumberAcceptedWorkRequests =3,
            NumberTransactionsConcluded=0,
            VolumeTransactionsConcluded =0,
            NumberGeneratedProjects=11,
            VolumeGeneratedProjects = 270m,
            VolumeWorkPerformed =0,
            AmountFunding = 364
        };

        TechTransferCenter id2 = new()
        {
            Id = 2,
            X = 55.54611705292226f,
            Y = 30.42186506338951f,
            ...
            NumberAcceptedWorkProposals = 3,
            NumberAcceptedWorkRequests = 2,
            NumberTransactionsConcluded = 0,
            VolumeTransactionsConcluded = 0,
            NumberGeneratedProjects = 2,
            VolumeGeneratedProjects = 20m,
            VolumeWorkPerformed = 3.2m,
            AmountFunding = 3868
        };

        TechTransferCenter id3 = new()
        {
           
            Id = 3,
            X = 54.92152753081758f,
            Y = 27.446527185623335f,
            ...
            NumberAcceptedWorkProposals = 8,
            NumberAcceptedWorkRequests = 4,
            NumberTransactionsConcluded = 0,
            VolumeTransactionsConcluded = 0,
            NumberGeneratedProjects = 12,
            VolumeGeneratedProjects = 259.7m,
            VolumeWorkPerformed = 0,
            AmountFunding = 0
        };

        TechTransferCenter id4 = new()
        {
            Id = 4,
            X = 53.59203819814071f,
            Y = 29.279894650774295f,
            ...
            NumberAcceptedWorkProposals = 3,
            NumberAcceptedWorkRequests = 1,
            NumberTransactionsConcluded = 0,
            VolumeTransactionsConcluded = 0,
            NumberGeneratedProjects = 1,
            VolumeGeneratedProjects = 0,
            VolumeWorkPerformed = 0.4m,
            AmountFunding = 0
        };

        TechTransferCenter id5 = new()
        { 
            Id = 5,
            X = 54.890263584744005f,
            Y = 27.563054778747336f,
            ...
            NumberAcceptedWorkProposals = 10,
            NumberAcceptedWorkRequests = 10,
            NumberTransactionsConcluded = 0,
            VolumeTransactionsConcluded = 0,
            NumberGeneratedProjects = 0,
            VolumeGeneratedProjects = 0,
            VolumeWorkPerformed = 85.7m,
            AmountFunding = 0
        };

        TechTransferCenter id6 = new()
        {
            Id = 6,
            X = 52.777413560458264f,
            Y = 26.93380577587773f,
        ...
        internal PredefinedTechTransferCenterList()
        {
